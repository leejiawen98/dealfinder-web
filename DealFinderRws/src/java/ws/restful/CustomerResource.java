...
import ws.datamodel.AddFavDealsReq;
...
//                c.getCreditCard().setCustomer(null);
            }
                                ...
                                @QueryParam("password") String password)
    {
        try
        {
            ...
            customer.getRedemptions().clear();
            customer.getFavourites().clear();            
            customer.getDeals().clear();
            customer.getReviews().clear();
            customer.getCreditCard().setCustomer(null);
    ...
    public Response retrieveCustomerByCustomerId(@PathParam("customerId") long customerId)
    {
        try
        {
            ...
            customer.getReviews().clear();
            customer.getDeals().clear(); 
            customer.setCreditCard(null); // added
