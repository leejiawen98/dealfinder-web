...
public class SessionBeanLookup 
{
    ...
    public ReviewSessionBeanLocal lookupReviewSessionBeanLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (ReviewSessionBeanLocal) c.lookup(ejbModuleJndiPath + "ReviewSessionBean!ejb.session.stateless.ReviewSessionBeanLocal");
        } catch (NamingException ne) {
            Logger.getLogger(getClass().getName()).log(Level.SEVERE, "exception caught", ne);
            throw new RuntimeException(ne);
        }
    ...
    public RedemptionSessionBeanLocal lookupRedemptionSessionBeanLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (RedemptionSessionBeanLocal) c.lookup(ejbModuleJndiPath + "RedemptionSessionBean!ejb.session.stateless.RedemptionSessionBeanLocal");
        } catch (NamingException ne) {
            Logger.getLogger(getClass().getName()).log(Level.SEVERE, "exception caught", ne);
            throw new RuntimeException(ne);
        }
        ...
        public FavouriteSessionBeanLocal lookupFavouriteSessionBeanLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (FavouriteSessionBeanLocal) c.lookup(ejbModuleJndiPath + "FavouriteSessionBean!ejb.session.stateless.FavouriteSessionBeanLocal");
        } catch (NamingException ne) {
            Logger.getLogger(getClass().getName()).log(Level.SEVERE, "exception caught", ne);
            throw new RuntimeException(ne);
        }
